...
<%
	...
	if(request.getParameter("subjectName")== null
		...
		msg = URLEncoder.encode("새로생성 할 Subject를  입력해주세요","utf-8");
		response.sendRedirect(request.getContextPath()+"/subject/insertSubject.jsp?msg="+msg);
		return;
	}
	//요청값 변수 저장
	...
	SubjectDao in = new SubjectDao();
	int row = in.insertSubject(subject);
	//row값 디버깅
